...
?>
	...
	<?php if ( bbp_current_user_can_access_create_topic_form() ) : ?>
		...
		<div id="new-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-form <?php epsilon_columnal_class_bbp(); ?>">
				...
				<fieldset class="bbp-form">
						<?php
							if ( bbp_is_topic_edit() ) :
								echo '<legend class="pre_2 '. epsilon_get_columnal_class_bbp( 8, true ) .'"><h4>';
								printf( __( 'Now Editing &ldquo;%s&rdquo;', 'bbpress' ), bbp_get_topic_title() );
							else :
								echo '<legend class="form-title '. epsilon_get_columnal_class_bbp() .'"><h4>';
					...
					<div>
						...
						<div class="bbp-submit-wrapper pre_2 <?php epsilon_columnal_class_bbp( 8, true ); ?> clearfix">
