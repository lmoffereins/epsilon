...
?>
	...
	<?php if ( bbp_current_user_can_access_create_reply_form() ) : ?>
		...
		<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form <?php epsilon_columnal_class_bbp(); ?>">
			...
			<form id="new-post" name="new-post" method="post" action="">
				...
				<fieldset class="bbp-form">
					<legend class="form-title <?php epsilon_columnal_class_bbp(); ?>"><h4><?php printf( __( 'Reply To: %s', 'bbpress' ), bbp_get_topic_title() ); ?></h4></legend>

					<?php do_action( 'bbp_theme_before_reply_form_notices' ); ?>

					<?php if ( !bbp_is_topic_open() && !bbp_is_reply_edit() ) : ?>

						<div class="bbp-template-notice pre_2 <?php epsilon_columnal_class_bbp( 8, true ); ?>">
					...
					<div>
						...
						<div class="clearfix">
							...
							<p class="<?php epsilon_columnal_class_bbp( 8, true ); ?>">
						...
						<?php if ( !current_user_can( 'unfiltered_html' ) ) : ?>
							...
							<div class="clearfix">
								<p class="form-allowed-tags col_2">
						...
						<?php if ( bbp_allow_revisions() && bbp_is_reply_edit() ) : ?>
							...
							<fieldset class="bbp-form">
								<legend class="pre_2 <?php epsilon_columnal_class_bbp( 8, true ); ?>"><h4><?php _e( 'Revision', 'bbpress' ); ?></h4></legend>
								<div class="pre_2 <?php epsilon_columnal_class_bbp( 8, true ); ?> clearfix">
						...
						<?php else : ?>
							...
							<p class="pre_2 <?php epsilon_columnal_class_bbp( 8, true ); ?>"><?php bbp_topic_admin_links(); ?></p>
	...
	<?php elseif ( bbp_is_topic_closed() ) : ?>
		...
		<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply pre_2 <?php epsilon_columnal_class_bbp( 8, true );; ?>">
