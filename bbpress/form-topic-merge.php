...
?>
	...
	<?php if ( is_user_logged_in() && current_user_can( 'edit_topic', bbp_get_topic_id() ) ) : ?>
		...
		<div id="merge-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-merge <?php epsilon_columnal_class_bbp(); ?>">

			<form id="merge_topic" name="merge_topic" method="post" action="">

				<fieldset class="bbp-form">

					<legend><h3><?php printf( __( 'Merge topic "%s"', 'bbpress' ), bbp_get_topic_title() ); ?></h3></legend>
					...
					<div>
						...
						<fieldset class="bbp-form">
							<legend class="pre_2 <?php epsilon_columnal_class_bbp( 8, true ); ?>"><h4><?php _e( 'Destination', 'bbpress' ); ?></h4></legend>
							<div>
